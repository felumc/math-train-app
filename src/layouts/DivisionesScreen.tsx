...
const DivisionesScreen: React.FC<any> = ({navigation}) => {
    ...
    <SafeAreaView style={theme === "light" ? styles.container : [styles.container, {backgroundColor: "black"}]}>
      ...
      <Text style={[styles.title, theme === "light" ? {color: myColors.black} : {color: myColors.white}]}>Divisiones ✍️</Text>
      <Text style={[styles.subtitle, theme === "light" ? {color: myColors.black} : {color: myColors.white}]}>Resuelve a 2 decimales:</Text>
      <Text style={[styles.title, theme === "light" ? {color: myColors.black} : {color: myColors.white}]}>{num1} / {num2}</Text>
      <MyKeyboard result={(num1 / num2).toFixed(2)} onAlert={handleAlert} />
...
export default DivisionesScreen;