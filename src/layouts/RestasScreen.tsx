...
const RestasScreen: React.FC<any> = ({navigation}) => {
    ...
    <SafeAreaView style={theme === "light" ? styles.container : [styles.container, {backgroundColor: "black"}]}>
      ...
      <Text style={[styles.title, theme === "light" ? {color: myColors.black} : {color: myColors.white}]}>Restas ✍️</Text>
